...
if __name__ == "__main__":
    ...
    tam_vector = 50 # 50  Dimensionalidad de los vectores de palabras.
    ventana = 5 # 10 ventana ( int , opcional ): distancia máxima entre la palabra actual y la palabra prevista dentro de una oración.
    ...
    # modelos_swmwosge_1008211100 80851200
    modelo_dir =  RESULTADOS_DIR+ '/archivos_out/modelos_swmwosge_5051100/estabilidad_procrustes/'
