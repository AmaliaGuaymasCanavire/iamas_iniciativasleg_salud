...
if __name__ == "__main__":
    ...
    # Crear directorio para algoritmo de cambio semántico modelos_swmwosge_1008211100 50881200 80851200
    modelo_dir =  RESULTADOS_DIR+ './archivos_out/modelos_swmwosge_5051100/estabilidad_NN/'
