...
if __name__ == "__main__":
    ...
    tam_vector = 80 # 50  Dimensionalidad de los vectores de palabras.
    ...
    e = 150 # 50 Número de iteraciones (épocas) en el corpus. (Anteriormente: iter )
    ...
    modelo_dir =  RESULTADOS_DIR+ '/archivos_out/modelos_swmwosge_808811150/estabilidad_procrustes/'
